...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	@Override
	public List<LancamentoEstatisticaDia> porDia(LocalDate mesRenferencia) {
		...
		LocalDate primeiroDia = mesRenferencia.withDayOfMonth(1);
		LocalDate ultimoDia = mesRenferencia.withDayOfMonth(mesRenferencia.lengthOfMonth());
	...
	@Override
	public List<LancamentoEstatisticaCategoria> porCategoria(LocalDate mesRenferencia) {
		CriteriaBuilder criteriaBuilder = manager.getCriteriaBuilder();
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroRegistoDaPagina = paginaAtual * totalRegistroPorPagina;
